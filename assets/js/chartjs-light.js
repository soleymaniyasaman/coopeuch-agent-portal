...
$(function () {
  ...
  if ($('#chartjsLine').length) {
    var lineChartCanvas = document.getElementById('chartjsLine');

    // Set a specific height for the chart canvas
    lineChartCanvas.height = 220; // Set the desired height in pixels
  ...
  if ($('#chartjsLineCommission').length) {
    var lineChartCommissionCanvas = document.getElementById('chartjsLineCommission');

    // Set a specific height for the chart canvas
    lineChartCommissionCanvas.height = 220; // Set the desired height in pixels

    new Chart(lineChartCommissionCanvas, {
      type: 'line',
      data: {
        labels: [1850, 1900, 1950, 1999, 2050],
        datasets: [{
  ...
  if ($('#chartjsGroupedBar').length) {
    var barChartCanvas = document.getElementById('chartjsGroupedBar');

    // Set a specific height for the chart canvas
    barChartCanvas.height = 220; // Set the desired height in pixels

    new Chart(barChartCanvas, {
      type: 'bar',
      data: {
        labels: ["1950", "1999", "2050"],
        datasets: [
          {
            label: "Completed Quotes",
            boxWidth: '8px',
            backgroundColor: colors.danger,
            data: [2210, 4783, 12478],
          }, {
  ...
  // Grouped Bar GWP Chart
  if ($('#chartjsGroupedBarGWP').length) {
    var barChartGWPCanvas = document.getElementById('chartjsGroupedBarGWP');

    // Set a specific height for the chart canvas
    barChartGWPCanvas.height = 220; // Set the desired height in pixels

    new Chart(barChartGWPCanvas, {
      type: 'bar',
      data: {
