$(function () {
  ...
  if ($('#quotesChart').length) {
    ...
    new ApexCharts(document.querySelector("#quotesChart"), options2).render();
  }
  // Quotes Chart - END
  ...
  if ($('#policiesChart').length) {
    ...
    new ApexCharts(document.querySelector("#policiesChart"), options3).render();
  }
  // Policy Chart - END
  ...
  if ($('#gwpChart').length) {
    ...
    var apexLineChart = new ApexCharts(document.querySelector("#gwpChart"), lineChartOptions);
  ...
  if ($('#policyChart').length) {
    var lineChartOptions = {
      ...
      xaxis: {
        type: "datetime",
        categories: policyChartCategories,
        lines: {
          show: true
        },
        axisBorder: {
    ...
    var apexLineChart = new ApexCharts(document.querySelector("#policyChart"), lineChartOptions);
    apexLineChart.render();
  }
  // Policy huge Chart - END

  // Conversion huge Chart
  if ($('#conversionChart').length) {
    ...
    var apexLineChart = new ApexCharts(document.querySelector("#conversionChart"), lineChartOptions);
    apexLineChart.render();
  }
  // Conversion huge Chart - END
  ...
  if ($('#gwpChartRTL').length) {
    ...
    var apexLineChart = new ApexCharts(document.querySelector("#gwpChartRTL"), lineChartOptions);
    apexLineChart.render();
  }
  // GWP Chart - RTL - END
  ...
  if ($('#QuoteHugeChart').length) {
    ...
    var apexBarChart = new ApexCharts(document.querySelector("#QuoteHugeChart"), options);
    apexBarChart.render();
  }
  // Quote huge Chart - END
